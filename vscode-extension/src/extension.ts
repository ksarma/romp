...
// socket, is the same-user trust boundary; /healthz and /version stay exempt). Same resolution order as the kernel's _load_token: env override, else the state file.
...
// 2026-07-14, who wanted the button the web view has — the browser's drift
