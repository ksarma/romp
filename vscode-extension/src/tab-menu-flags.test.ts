...
test("each toggle item carries an icon (slashed when off) and a sub-description", () => {
  assert.match(SRC, /function ctxIcon\(kind: "feed" \| "mail" \| "bell" \| "bill" \| "folder" \| "tag" \| "pencil" \| "smile", off: boolean\)/);   // bill 2026-08-09; folder/tag/pencil 2026-08-24; smile 2026-09-06
