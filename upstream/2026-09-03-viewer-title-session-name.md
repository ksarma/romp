...
MERGED 2026-09-07: their PR #970 merged as-is (merge 26219f4c, head e8da8022; two review nits folded before the merge), together with the Files-pane entry's quote-seed commit (`files-pane`).
