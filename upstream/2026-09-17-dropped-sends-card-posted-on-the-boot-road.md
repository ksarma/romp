...
2026-09-18: approved for offer by the user (batch 2 of the 2026-09-18 plan; his answer covers the fix and docs entries of batches 2 to 7, batch by batch, features excluded). Filed stacked on prod-converge-rebuild (shared file kernel/kernel.py).

2026-09-19: offered as their PR #1883 (batch 2 of the 2026-09-18 plan, position 7, stacked on #1881; head 2378fa77a on 7828eec6a); the next entry, queued-sends-not-fused, is cut from this branch's final head.

2026-09-19: merged upstream as their PR #1883 at 10:09:44Z (merge 0fa4c7c9f); the row read offered until the stale check of 2026-09-21 found it
