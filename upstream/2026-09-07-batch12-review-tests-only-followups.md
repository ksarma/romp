...
OFFERED 2026-09-07: offered upstream as their PR #965 (2026-09-07, label tests-only, head 7ae11680), together with the presence-blink ordering fix (`presence-blink-honesty-order`), which rode in the same PR.
