...
OFFERED 2026-09-08: offered upstream inside bundle PR #1058 (Postal heartbeat: one fetch per beat, none once the bus confirms local; the chat fold seals plain Bash turns; label fix; branch postal-fold-offer; head 9154c9da) with `postal-heartbeat-once-per-beat`.

MERGED 2026-09-08: merged upstream as their PR #1058 (merge 0e15f299, 2026-09-08T13:11:16Z) after the maintainer's own review commit cb3f0d17 (romp mail remote refuses in peer mode after the latch; blink-time reachability pinned), which the fork should fold.
