...
OFFERED 2026-09-07: offered upstream as their PR #964 (2026-09-07, label tests-only, head b51bb1ec), together with the `set_model` / `set_effort` docs pair (`docs-set-model-effort-fast-badge`), which rode in the same PR.

MERGED 2026-09-07: their PR #964 merged as-is (merge 2b9ddfe8, head b51bb1ec).
