...
OFFERED 2026-09-08: offered upstream inside bundle PR #1062 (Judge: an evidence gate for all six tiers and three correctness fixes at the judge's head; label feature; branch judge-gates-offer; head 13988491; a draft while the branch is rebased onto the moved upstream tip; stacked on their PR #1059, which must merge first) with `judge-head-three-fixes` and `judge-gate-store-tiers`. `unread-store-save`, planned into this bundle, came off at the rebase as moot under upstream's #1019.
