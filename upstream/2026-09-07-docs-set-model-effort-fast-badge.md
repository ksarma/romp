...
OFFERED 2026-09-07: offered upstream as their PR #964 (2026-09-07, label tests-only, head b51bb1ec), together with the postal kind-prefix entry (`postal-kind-prefix-teaching`), which rode in the same PR.
