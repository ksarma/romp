...
OFFERED 2026-09-08: offered upstream inside bundle PR #1058 (Postal heartbeat: one fetch per beat, none once the bus confirms local; the chat fold seals plain Bash turns; label fix; branch postal-fold-offer; head 9154c9da) with `chat-fold-plain-bash-seals`.
