...
2026-09-18: resolved upstream. https://github.com/romp-on/romp/pull/1636 (merge 45b17d1d8, 2026-09-14) put the death marker, cleared.jsonl and the stall slice into _plan_key; the function is byte-identical at the two tips. Residue, a docs-tier pin if wanted: tests/test_planner_key_terms.py.
