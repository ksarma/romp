...
test('the UX section, the Tests bullet and the Docs sentence carry the two decisions, and every module the bullet names is in the tree', () => {
  ...
  assert.ok(map.includes('function wrapRuns('), 'and wrapRuns');
