...
class Pins(unittest.TestCase):
    ...
    def test_backend_wiring(self):
        ...
        self.assertIn("if _send_with_id(be, sid, text, qid, user=user, paths=paths, user_todo=user_todo) is False:", ksrc, "the park-or-send route hands on who speaks and what rode along; the caller that knows classifies (T315; the attachment list, T373; the user request the text answers)")
