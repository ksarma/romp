...
# throwaway env with pytest and cryptography (CI's Python set less pytest-timeout, pytest-xdist and
# the pinned SDK, so the SDK-gated tests may skip there), else a LOUD failure naming both remedies, before any
