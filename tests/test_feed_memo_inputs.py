...
HELPERS = {
    ...
    # this fork's user-todo floor (re-applied inside the body at the 2026-09-15 pull-in): the idle judgement over the
    # open todos, the parse, the live row, the wait edge and the queued sends; the goal-less placeholder's clock
    "_user_todo_idle": ("sig", ("todos", "queued", "transcript", "parse", "states", "row", "wait")),
...
MODULE_READS = {
    ...
    "_USER_TODO_BLOCK_WHAT": ("const", "the floor's block text (this fork's user-todo floor)"),
}
