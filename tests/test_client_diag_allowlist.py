    ...
    def test_one_fixture_row_per_poster_call_site_passes_whole_and_the_table_names_nothing_else(self):
        ...
        posters = {
            ...
            "shell": [   # the shell scripts' shellDiag rows (kernel.py)
                ...
                ("pane-load-unmarked", {"pane": "waiting", "via": "load"}),   # review round 3 (2026-09-19, family two; a 200 alone since round 4, the kernel's stamp): a 200 the kernel served at the pane's url with no pane shim, shown as served and said
            ],
        }
