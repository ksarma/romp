...
EXPECTED_BARE = {
    ...
    # test_user_todos.py keeps its own copy of that variant probe to cover the answer body's two halves
    # (_user_todo_answer_body, which the standalone neutralizer suite does not exercise): the same assembled
    # comment-form string, one bare hit.
