...
setup() {
    ...
    # 59 skipped with one incomplete run, 5 /tick requests and 3 WebSocket connects. B's lifetime figures
    # (cycle_ms_max 900, ms_mean 1012.5) differ from the window's
...
{"now": 1000.0, "since": 900.0, "uptime_s": 100.0, "log": false,
 ...
 "memos": {"chain": {"hit": 400, "miss": 40, "populate": 40, "bypass": 0}},
...
{"now": 1010.0, "since": 900.0, "uptime_s": 110.0, "log": false,
 ...
 "memos": {"chain": {"hit": 490, "miss": 43, "populate": 43, "bypass": 0}},
