...
timezone, wrong by the whole UTC offset the moment they didn't (the user 2026-08-10, reading a UTC
devbox's dashboard from their Mac). The transcript's own records were never affected: the CLI
