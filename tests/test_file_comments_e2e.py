#!/usr/bin/env python3
"""File comments (plans/file-review.md, Slices 1 to 3) — end to end, with nothing stubbed below the wire.
...
PNG the test builds from bytes, hashed by the host and regenerated by the test. Only what needs a live session is
