...
const RULES = [
  ...
  "a.fileview-btn {", "a.fileview-btn[hidden] {",
  'a.fileview-btn[aria-disabled="true"] {', 'a.fileview-btn[aria-disabled="true"]:hover {',
  'a.fileview-btn[aria-disabled="true"]:active {', "a.fileview-gh-note {", ".fileview-body {",
