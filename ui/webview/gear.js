...
var GEAR_HTML =
  ...
  "<div class='rs-row rs-jrow'><b>Indexing effort <span class=rs-mixed hidden></span></b><span class=rs-sub>Thinking effort for the indexing judges. Default keeps this high-volume work cheap: effort low on models with adaptive thinking (Fable, Opus, Sonnet); Haiku has no adaptive thinking, so it runs with thinking off and no effort flag. Follows to every connected machine's kernel.</span><select id=rs-indexeffort></select></div>" +
