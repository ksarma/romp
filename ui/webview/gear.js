...
var GEAR_HTML =
  ...
  '</span></label>' +
  // WAITING ON YOU (the fork, plans/user-todos.md): the User todos switch, per machine like Thinking summaries above (the LOCAL
  // kernel's answer, never a KERNEL_SETTING), so it sits beside it in Chat; the fork's row, re-placed here from the old Sessions
  // section when upstream re-cut the card (T400, T404)
  "<div class='rs-sec' data-section=usertodos>Waiting on you</div>" +
