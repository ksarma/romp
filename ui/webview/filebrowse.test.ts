...
function viewerUp(): Viewer {
  ...
  // this fork's viewer puts the body in a ROW beside the Comments aside (plans/file-review.md Slice 1): the card's last
  // child is the row, and the body is its .fileview-body child (upstream's card ends in the body itself)
