...
function world(): World {
  ...
  w.ctx = {
    ...
    body: () => body as unknown as HTMLElement, mode: () => "rendered", text: () => DOC, mtimeNs: () => "1757145600000000001", error: () => null, media: () => null, mediaElement: () => null, renderedImages: () => [], pdfPages: () => [],
