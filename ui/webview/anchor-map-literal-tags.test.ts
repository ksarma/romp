...
test("void and self-closing tags are unchanged in the output and in the map: `<br>`, `<img src=...>`, `<x/>`, `<wbr>`, `<input>`, `<hr>` inline: the viewer's HTML is marked.parse's for the same input, and the prose around them maps", () => {
