...
function world(over: { path?: string; sid?: string | null; todoId?: string | null; src?: string; mtimeNs?: string } = {}): World {
  ...
  w.ctx = {
    ...
    body: () => body as unknown as HTMLElement, mode: () => "raw", text: () => text, mtimeNs: () => over.mtimeNs ?? "1757145600000000001", error: () => null, media: () => null, mediaElement: () => null, renderedImages: () => [], pdfPages: () => [],
