...
const PLANT_TABLE: Plant[] = [
  ...
  { dir: W, file: "p58-member-to-value.test.ts", leg: false, cls: "none", gap: "never calls its inBrowser through that import", launcherImported: true, refused: "p58-member-to-value.test.ts:3: the launcher's module binding handed on as a value" }, // extra7-2: const run = leg.inBrowser
  { dir: W, file: "p59-namespace-alias.test.ts", leg: false, cls: "none", gap: "never calls its inBrowser through that import", launcherImported: true, refused: "p59-namespace-alias.test.ts:3: the launcher's module binding handed on as a value" }, // extra7-2: const alias = leg
  { dir: W, file: "p60-destructure-namespace.test.ts", leg: false, cls: "none", gap: "never calls its inBrowser through that import", launcherImported: true, refused: "p60-destructure-namespace.test.ts:3: the launcher's module binding handed on as a value" }, // extra7-2: const { inBrowser } = leg
  { dir: W, file: "p61-namespace-as-argument.test.ts", leg: false, cls: "none", gap: "never calls its inBrowser through that import", launcherImported: true, refused: "p61-namespace-as-argument.test.ts:4: the launcher's module binding handed on as a value" }, // extra7-2: go(leg, t)
