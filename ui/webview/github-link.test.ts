...
// file-OWNING kernel (git on ITS disk — federation routes by sid), an anchor that appears only when
// a real URL comes back. Source pins (no jsdom for these modules), the repo convention.
