...
export const DEFAULT_SETTINGS: RompSettings = { compact: true, colormap: "aurora", subgoals: true, showIndexJudges: false, showTriageJudges: false, backend: "sdk", defaultDir: "", showBranch: false, tabCtx: "over50", stripGroupRows: false, fileLinkPane: "chat", chatScheme: "default", chatTabTheme: "classic", theme: "classic", changesInline: true, commentsFilter: "all" };
