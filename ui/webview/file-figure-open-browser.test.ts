...
// 0ab74924c as at the fix, by design (the stale records too: there the covered tap's own press was the record its click read; and
// the clicks after a drag, Chromium's drag ending its press with a pointercancel and the next press sending its pointerdown);
