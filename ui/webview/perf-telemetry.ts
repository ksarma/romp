...
// paint pass as `fileview:paint` (a text body painted) and `fileview:reflow` (the panel's re-paint over unchanged
// text: the body's width moved, or a text-size step), so the cost of a large reviewed file shows per minute under app "files"; and the
