...
// paint pass as `fileview:paint` (a text body painted) and `fileview:reflow` (the panel's re-paint after the
// body's width moved), so the cost of a large reviewed file shows per minute under app "files"; and the
