 ...
 *  which it reads in CSS pixels at every zoom, names that round). A property pin: the count is compared to the derived list, whose
 *  lines the message prints. */
const VIEWER_UNITS = 31;
