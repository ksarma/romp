 ...
 *  one predicate of whose click a figure's is, names that round). A property pin: the count is compared to the derived
 *  list, whose lines the message prints. */
const VIEWER_UNITS = 19;
