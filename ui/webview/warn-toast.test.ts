...
test("render handles kernel warn messages with a toast", () => {
  ...
  // dialog and retires the provisional tab. Every other warn still gets the toast. The emoji dialog's
  // refusal is a typed emojiRefused frame — tab-emoji.test.ts — never a warn claimed on timing, 2026-09-07.)
