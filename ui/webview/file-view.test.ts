...
test("the chat caches the shell's pane set (and which panes exist) from its romp:panes broadcast, and openPath reads the Files bits from it", () => {
  ...
  // the whole-set replace, with the idle prefetch's re-arm on the word that brings the chat on screen (stage 0, review round 1, 2026-09-19: skeleton-tabs-wiring.test.ts pins the belt itself)
