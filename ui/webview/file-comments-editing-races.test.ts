...
function world(): World {
  ...
  w.ctx = {
    ...
    post: (m) => { w.posted.push(m); }, ensureEditingAllowed: () => w.consent(), setEditBlocked: (r) => { w.blocked.push(r); }, editing: () => w.editing, setTrackedEdit: (t) => { w.tracked = t; }, guardClose: () => { /* inert */ },
